...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_resolution_grille_5" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#f7c005dc#;
   pragma Export (C, u00001, "test_resolution_grille_5B");
   ...
   u00149 : constant Version_32 := 16#ba2ff2cb#;
