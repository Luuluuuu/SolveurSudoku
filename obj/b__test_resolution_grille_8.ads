...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_resolution_grille_8" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#2a91fd14#;
   pragma Export (C, u00001, "test_resolution_grille_8B");
