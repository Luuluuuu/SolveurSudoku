...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_resolution_grille_1" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#8558542f#;
   pragma Export (C, u00001, "test_resolution_grille_1B");
   ...
   u00149 : constant Version_32 := 16#3bc5498d#;
