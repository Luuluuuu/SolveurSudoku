...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_resolution_grille_7" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#94514e40#;
   pragma Export (C, u00001, "test_resolution_grille_7B");
   ...
   u00149 : constant Version_32 := 16#5ebafb0a#;
