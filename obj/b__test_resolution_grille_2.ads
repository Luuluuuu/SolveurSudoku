...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_resolution_grille_2" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#ea708523#;
   pragma Export (C, u00001, "test_resolution_grille_2B");
