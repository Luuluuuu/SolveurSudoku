...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_resolution_grille_4" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#7bfea8bf#;
   pragma Export (C, u00001, "test_resolution_grille_4B");
